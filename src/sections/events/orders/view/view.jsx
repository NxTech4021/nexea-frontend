                  ...
                  {STATUS_TABS.map((status, index) => {
                    ...
                    if (isActive) {
                      if (status === 'All') {
                        ...
                        buttonBgColor = (theme) => theme.palette.mode === 'light' ? '#F3F4F6' : 'rgba(255, 255, 255, 0.08)';
                      } else {
                    ...
                    if (isActive) {
                      if (status === 'All') {
                        hoverBgColor = (theme) => theme.palette.mode === 'light' ? '#F3F4F6' : 'rgba(255, 255, 255, 0.08)';
                      } else {
                    ...
                    return (
                      <Button
                        ...
                        startIcon={status !== 'All' ? <Iconify icon={statusConfig.icon} sx={{ width: 18, height: 18 }} /> : null}
                        sx={{ 
                ...
                >
                  <Stack
                    ...
                    sx={{
                      ...
                      bgcolor: (theme) => theme.palette.mode === 'light' ? '#f1f2f3' : 'background.neutral',
                  ...
                  >
                    <Stack 
                      ...
                      sx={{ 
                        width: '100%',
                        '& > *:not(:last-child)': {
                          borderRight: (theme) => `1px solid ${theme.palette.mode === 'light' ? '#dedfe2' : 'rgba(255, 255, 255, 0.12)'}`,
                          pr: 2,
                          mr: 2,
                        }
                      }}
                    >
                      <Typography variant="subtitle2" sx={{ 
                        width: '15%', 
                        color: (theme) => theme.palette.mode === 'light' ? '#151517' : 'common.white', 
                        fontWeight: 550 
                      }}>
                        Order ID
                      </Typography>
