...
export const availabilities = [
    ...
    { id: 6, name: 'Standard - Startup (Entrepreneur Summit V)' },
    { id: 7, name: 'Standard - General - Investor (Entrepreneur Summit V)' },
    { id: 8, name: 'Standard - General - Government (Entrepreneur Summit V)' },
    { id: 9, name: 'Standard - General - Corporate (Entrepreneur Summit V)' },
    { id: 10, name: 'Standard - General - Entrepreneur (Entrepreneur Summit V)' }
];
...
function generateDiscountCodes(num) {
    ...
    for (let i = 0; i < num; i++) {
        ...
        const code = {
            ...
            status: isExpired ? 'Expired' : 'Active', // Set status based on expiration
        };
